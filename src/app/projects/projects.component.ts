...
export class ProjectsComponent implements OnInit {
  ...
  getLanguages(urlExtension: string): any {
    let language: { name: string, percentage: number, color: string }[] = [];
    let sum: number = 0;
    let currentLanguagePercentage: number = 0;
    let languageColor: string = '';

    this.githubService.getData(urlExtension).subscribe(data => {
      for (let languageName in data) {
        sum += data[languageName];
      }
      ...
      for (let languageName in data) {
        ...
        currentLanguagePercentage = data[languageName] / sum * 100;

        var languageElement = {
          name: languageName, percentage: Math.round((currentLanguagePercentage + Number.EPSILON) * 100) / 100, color: languageColor 
        };

        language.push(languageElement);
      }
    })
    return language;
  }
  ...
  projects = [
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/Portfolio/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/WebServerWithUserPrivileges/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/WebServerWithDatabase/languages'),
      description: [
        {
    ...
    {
      name: "Clippy",
      languages: this.getLanguages('/repos/BlackOutDevelops/Clippy/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/ShippingManagementWithMultithreading/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/ServerAndClient/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/CacheSimulator/languages'),
      description: [
        {
    ...
    {
      name: "Stick Note Copy Cat",
      languages: this.getLanguages('/repos/BlackOutDevelops/StickyNoteCopyCat/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages("/repos/BlackOutDevelops/Photo-TANK-RC/languages"),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/EmbeddedSystemLabs/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/Adaboost/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/VerilogProject/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/OpticalFlow/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/Marr-HildrethEdgeDetector/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/SobelEdgeDetector/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/DesignUsingRootLocus/languages'),
      description: [
        {
    ...
    {
      name: "FileDotCom",
      languages: this.getLanguages('/repos/BlackOutDevelops/FileDotCom/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/DijkstraBellmanFloyd/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/Dijkstra/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/SkipList/languages'),
      description: [
        {
    ...
    {
      name: "Hashtastic",
      languages: this.getLanguages('/repos/BlackOutDevelops/Hashtastic/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/KindredSpirits/languages'),
      description: [
        {
    ...
    {
      name: "Listy Fib",
      languages: this.getLanguages('/repos/BlackOutDevelops/ListyFib/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/LonelyPartyArray/languages'),
      description: [
        {
    ...
    {
      name: "Domichar",
      languages: this.getLanguages('/repos/BlackOutDevelops/Domichar/languages'),
      description: [
        {
    ...
    },
    {
      ...
      languages: this.getLanguages('/repos/BlackOutDevelops/BranchPredictor/languages'),
      description: [
        {
    ...
    {
      name: "Line Follower",
      languages: this.getLanguages("/repos/SamiESK/AI_Project/languages"),
      description: [
        {
